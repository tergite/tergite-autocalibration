...
nodes = ['cz_dynamic_phase','cz_calibration_ssro','cz_calibration','cz_chevron','ro_amplitude_optimization_gef','ro_frequency_optimization_gef','resonator_spectroscopy_2','n_rabi_oscillations','motzoi_parameter','tof', 'resonator_spectroscopy', 'qubit_01_spectroscopy_pulsed', 'qubit_01_spectroscopy_multidim', 'rabi_oscillations', 'ramsey_correction', 'resonator_spectroscopy_1', 'ro_frequency_optimization', 'T1','T2','T2_echo', 'qubit_12_spectroscopy_pulsed', 'ro_amplitude_optimization', 'qubit_12_spectroscopy_multidim', 'rabi_oscillations_12', 'state_discrimination', 'ramsey_correction_12','coupler_spectroscopy','coupler_resonator_spectroscopy', 'punchout' ]
