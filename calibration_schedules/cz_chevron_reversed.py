...
from quantify_scheduler.operations.pulse_library import IdlePulse,DRAGPulse,SetClockFrequency,NumericalPulse,SoftSquarePulse,SquarePulse
    ...
    def schedule_function(
        ...
        for freq_index, cz_frequency in enumerate(cz_frequency_values):
            ...
            for acq_index, cz_duration in enumerate(cz_duration_values):
                ...
                # reset test
                # buffer = schedule.add(IdlePulse(4e-6-cz_duration))
...
class CZ_chevronDuration(Measurement):
