...
It is tailored for the tune-up of the 25 qubits QPU at Chalmers, which is receiving generous funding by the Wallenberg
Centre for Quantum Technology ([WACQT](https://wacqt.se)) for research, development and operation.

### [User Guide](getting_started.qmd)

A section with a tutorial on how to get started with the automatic calibration.
...
This repository is an actively developed open-source project and also part of a full-stack to operate a quantum
computer.
