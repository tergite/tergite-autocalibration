...
Qubit spectroscopy is a vital technique for identifying qubit resonance frequencies. By applying a probing signal to a qubit at various frequencies and measuring the response, we can accurately locate resonance frequencies and optimize qubit operation.

### Class: `Two_Tones_Multidim`
...
2. **Frequency Sweeping**: Iteratively adjusts the probing frequency and amplitude.
3. **Measurement**: Captures the qubit response at each probing point.
...
The `QubitSpectroscopyMultidim` class analyzes the results of qubit spectroscopy experiments. It fits a Lorentzian function to the collected data, enabling the determination of resonance frequencies.
...
2. Fit a Lorentzian function to identify the resonance peak.
