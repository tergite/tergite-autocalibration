...
The `analyse_qubit` method processes and fits the data to determine the resonator’s **resonant frequency** and **loaded Q-factor**. The `analyse_qubit`fit should resamble a negative Gaussian distribution.
