...
def reboot():
    ...
    from tergite_calibration.config.settings import CLUSTER_IP
...
def start(c, d, push):
    ...
    from tergite_calibration.config.settings import CLUSTER_IP
    from tergite_calibration.scripts.calibration_supervisor import CalibrationSupervisor
    from tergite_calibration.scripts.db_backend_update import update_mss
