...
see [how to load and save configuration packages](operation.qmd#configuration-commands).
...
couplers = ["q01_q02"]
cooldown = "13/05/2025"
name = "my_experiment_with_T2"
is_internal = true
runner_logo = "resources/runner_logo.png"
```
With the `name`, you can give your experiment a name that will be utilized e.g. to create an output folder for the plots.
The `cooldown` parameter is to print a note on which cooldown the experiment happened.
Likewise, the `runner_logo` will be printed on top of the figures.
...
about [how to load and save configuration packages](operation.qmd#configuration-commands).