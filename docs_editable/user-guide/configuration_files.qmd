...
Given a `.csv` file after a mixer calibration the function `utils/hw_generator.py` can create instantly the
...
and the the property is a property known to the node.
