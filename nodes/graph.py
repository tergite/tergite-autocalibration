...
graph_dependencies = [
    ...
    ('resonator_spectroscopy_1', 'ro_frequency_optimization'),
    ('ro_frequency_optimization', 'ro_amplitude_optimization_gef'),
    # ('ro_frequency_optimization', 'state_discrimination'),
