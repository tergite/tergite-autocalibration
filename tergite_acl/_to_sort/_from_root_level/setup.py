...
setuptools.setup(
    ...
    long_description="Minimal version of the automatic calibration under the tergite framework. Communication handling and calibration_schedules library for the automatic characterization and tune-up of a multi-qubit device. Designed only for Qblox clusters control instruments.",
