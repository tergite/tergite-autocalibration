...
def test_dummy_01_generation():
    ...
    node_01 = RabiOscillationsNode("rabi_oscillations", CONFIG.run.qubits , CONFIG.run.couplers)
...
def test_dummy_12_generation():
    ExtendedTransmon.close_all()  # ensure no other transmon objects are instantiated
    node_12 = RabiOscillations12Node("rabi_oscillations_12", CONFIG.run.qubits , CONFIG.run.couplers)
...
def test_dummy_n_rabi_generation():
    ExtendedTransmon.close_all()  # ensure no other transmon objects are instantiated
    node_n_rabi = NRabiOscillationsNode("n_rabi_oscillations", CONFIG.run.qubits , CONFIG.run.couplers)
