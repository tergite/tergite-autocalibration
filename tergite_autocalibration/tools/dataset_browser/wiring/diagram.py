...
class Attenuator:
    def __init__(self, ax, line, stage, value, position):
        ...
        rect = patches.Rectangle((self.x_position, self.y_position), width, height, **kwargs)
...
class Circulator:
    def __init__(self, ax, line, stage, value, position):
        ...
        rect = patches.Arrow(self.x_position + width/2, self.y_position, 0, height, width=0.6, **kwargs)
...
class Line:
    ...
    def __init__(self, ax, line, components):
        ...
        self.ax.text(
            self.line, 7*stage_spacing, str(line),
