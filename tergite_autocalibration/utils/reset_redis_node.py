...
class ResetRedisNode:
    ...
    nodes = node_factory.all_node_names()
    # TODO: node_factory.node_implementations will have the wrong type
    #       Possible solutions:
    #       - Have a factory function to get the node class and not an instance
    #       - Traverse the AST
